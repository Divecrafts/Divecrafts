package io.clonalejandro.DivecraftsCore.particles;
...
public enum Particles {
     ...
     * <p>
     * This class is part of the <b>Particles Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
     * @since 1.7
     */
    ...
    public static final class ParticlePacket {
         ...
         * @see #Particles(String, int, int, ParticleProperty...) (Particles, float, float, float, float, int, boolean, ParticleData)
         */
